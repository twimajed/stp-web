...
define(function (require) {
  ...
  function loadChar() {
    ...
    var _canvasCtx = $('.cm001 >.panel >.canvaslist > .myChart')[0].getContext('2d');
  ...
  function init() {
    ...
    EL.get('api/mock/cm001').then(function (list) {
      $('.cm001 .processType').append(processType(list));
      $(".cm001 .processType").change(function(){
        var seleText= $(".cm001 .processTypeSele").find("option:selected").text();
